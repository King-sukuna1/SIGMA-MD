...
global.owner = process.env.OWNER_NUMBER  || '2347014128473' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://king:sukuna@cluster0.dh59i5n.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.mztit = process.env.MZTIT ||"𒅒༒☠︎︎༒𒅒",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
global.gurl  = 'https://www.youtube.com/@InnoxentTech?sub_confirmation=1' ; 
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/b44c6239710466c2e81d1.jpg' ;
//=================================================================================
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '14_07_2024_SIGMA_MD_sVNqw8Jw_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || '𝑲𝑰𝑵𝑮_𝑺𝑼𝑲𝑼𝑵𝑨-ᴍᴅ',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `𒅒༒☠︎︎𝖘𝖚𝖐𝖚𝖓𝖆☠︎︎༒𒅒`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || '𒅒༒☠︎︎𝖘𝖚𝖐𝖚𝖓𝖆☠︎︎༒𒅒',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "𝑲𝑰𝑵𝑮_𝑺𝑼𝑲𝑼𝑵𝑨-ᴍᴅ" ,          // ADD YOUR STICKER PACKNAME
  autoreaction: process.env.AUTO_REACTION || 'cmd',    // IF TRUE IT WILL REACT TO YOUR MESSAGES
